...
class FDMExplicit(object):
    ...
    def _buildFMatrix(self):
        ...
        # Ya tengo la matriz con los coeficientes Cij y Kij.
        # Si tengo el dt calculo dt/Mi y termino de armar la matriz.
        # Si no, empiezo a generar dts y a mirar la matriz. La teorida dice
        # que alpha<=0.5 para que el metodo sea estable. Como tengo mucho miedo
        # le vamos a poner 0.45
