...
model.addNode(Node(3, 1600.0, -273.0, lambda x: 5.80 , 'Interface ring'))
model.addNode(Node(4, 400.0,-273.0, lambda x: 8.06, 'Front panel radiator'))
model.addNode(Node(5, 450.0,-273.0, lambda x: 61.42, 'Front solar panel'))
model.addNode(Node(6, 450.0,-273.0, lambda x: 3.88, 'Rear solar panel'))
model.addNode(Node(7, 450.0,-273.0, lambda x: 65.03, 'Lateral solar panel _1'))
model.addNode(Node(8, 450.0,-273.0, lambda x: 65.03, 'Lateral solar panel _2'))
model.addNode(Node(9, 150.0,-273.0, lambda x: 4.12, 'Silicon cell SiCELL_2'))
model.addNode(Node(10, 150.0,-273.0, lambda x: 4.12, 'Silicon cell SiCELL_1'))
model.addNode(Node(11, 200.0,-273.0, lambda x: 1.06, 'RF antena'))
model.addNode(Node(12, 300.0,-273.0, lambda x: 1.83, 'Upper microSwitch'))
model.addNode(Node(13, 300.0, -273.0, lambda x: 0.20, 'Lower microSwitch'))
model.addNode(Node(14, 0.01,-273.0, lambda x: 7.40, 'MLI-Upper platform'))
model.addNode(Node(15, 0.01,-273.0, lambda x: 2.50, 'MLI-lateral_2'))
model.addNode(Node(16, 0.01, -273.0, lambda x: 8.11, 'MLI-Lower platform'))
model.addNode(Node(17, 0.01,-273.0, lambda x: 2.01, 'Shunt_2'))
model.addNode(Node(18, 0.01,-273.0, lambda x: 2.01, 'Shunt_1'))
model.addNode(Node(19, 0.01,-273.0, lambda x: 2.50, 'MLI-lateral_1'))
model.addNode(Node(20, 100.0, -273.0, lambda x: 1.37, 'GPS_1 Antenna'))
model.addNode(Node(21, 100.0,-273.0, lambda x: 1.07, 'GPS_2 Antenna'))
model.addNode(Node(22, 100.0, -273.0, lambda x: 1.37, 'GPS_3 Antenna'))
model.addNode(Node(23, 100.0,-273.0, lambda x: 1.07, 'GPS_4 Antenna'))
...
model.addNode(Node(26, 450.0,-273.0,  lambda x: 1.49*F_AREA, 'Radiator_2'))
model.addNode(Node(27, 450.0,-273.0,  lambda x: 1.49*F_AREA, 'Radiator_1'))
model.addNode(Node(28, 250.0, -273.0, lambda x: 0.0, 'Structure - lateral_2'))
model.addNode(Node(29, 3.0, -273.0, lambda x: 1.44, 'MLI - magnetometer'))
...
model.addNode(Node(32, 2.0,-273.0, lambda x: 0.0, 'Mathematical node'))
...
model.addAdmittance(20, 23,   1.378)                        #  from SSPTA
