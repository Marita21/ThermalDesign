...
model.addNode(Node(3, 1600.0, -273.0, lambda x: 7.70, 'Interface ring'))
model.addNode(Node(4, 400.0,-273.0, lambda x: 14.01, 'Front panel radiator'))
model.addNode(Node(5, 450.0,-273.0, lambda x: 73.44, 'Front solar panel'))
model.addNode(Node(6, 450.0,-273.0, lambda x: 4.84, 'Rear solar panel'))
model.addNode(Node(7, 450.0,-273.0, lambda x: 77.70, 'Lateral solar panel _1'))
model.addNode(Node(8, 450.0,-273.0, lambda x: 77.70, 'Lateral solar panel _2'))
model.addNode(Node(9, 150.0,-273.0, lambda x: 6.18, 'Silicon cell SiCELL_2'))
model.addNode(Node(10, 150.0,-273.0, lambda x: 6.18, 'Silicon cell SiCELL_1'))
model.addNode(Node(11, 200.0,-273.0, lambda x: 1.53, 'RF antena'))
model.addNode(Node(12, 300.0,-273.0, lambda x: 2.46, 'Upper microSwitch'))
model.addNode(Node(13, 300.0, -273.0, lambda x: 0.25, 'Lower microSwitch'))
model.addNode(Node(14, 3.0,-273.0, lambda x: 9.81, 'MLI-Upper platform'))
model.addNode(Node(15, 3.0,-273.0, lambda x: 3.16 , 'MLI-lateral_2'))
model.addNode(Node(16, 3.0, -273.0, lambda x: 9.93, 'MLI-Lower platform'))
model.addNode(Node(17, 3.0,-273.0, lambda x: 2.60, 'Shunt_2'))
model.addNode(Node(18, 3.0,-273.0, lambda x: 2.60, 'Shunt_1'))
model.addNode(Node(19, 3.0,-273.0, lambda x: 3.16, 'MLI-lateral_1'))
model.addNode(Node(20, 100.0, -273.0, lambda x: 1.73, 'GPS_1 Antenna'))
model.addNode(Node(21, 100.0,-273.0, lambda x: 1.35, 'GPS_2 Antenna'))
model.addNode(Node(22, 100.0, -273.0, lambda x: 1.73, 'GPS_3 Antenna'))
model.addNode(Node(23, 100.0,-273.0, lambda x: 1.35, 'GPS_4 Antenna'))
...
model.addNode(Node(26, 450.0,-273.0,  lambda x: 1.86*F_AREA, 'Radiator_2'))
model.addNode(Node(27, 450.0,-273.0,  lambda x: 1.86*F_AREA, 'Radiator_1'))
model.addNode(Node(28, 250.0, -273.0, lambda x: 0.0, 'Structure - lateral_2'))
model.addNode(Node(29, 3.0, -273.0, lambda x: 1.89, 'MLI - magnetometer'))
