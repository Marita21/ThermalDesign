...
model.addNode(Node(3, 1600.0, -273.0, lambda x: 4.58, 'Interface ring'))
model.addNode(Node(4, 400.0,-273.0, lambda x: 6.57, 'Front panel radiator'))
model.addNode(Node(5, 450.0,-273.0, lambda x: 43.20, 'Front solar panel'))
model.addNode(Node(6, 450.0,-273.0, lambda x: 5.11, 'Rear solar panel'))
model.addNode(Node(7, 450.0,-273.0, lambda x: 47.38, 'Lateral solar panel _1'))
model.addNode(Node(8, 450.0,-273.0, lambda x: 47.38, 'Lateral solar panel _2'))
model.addNode(Node(9, 150.0,-273.0, lambda x: 3.02, 'Silicon cell SiCELL_2'))
model.addNode(Node(10, 150.0,-273.0, lambda x: 3.02, 'Silicon cell SiCELL_1'))
model.addNode(Node(11, 200.0,-273.0, lambda x: 1.01, 'RF antena'))
model.addNode(Node(12, 300.0,-273.0, lambda x: 1.59, 'Upper microSwitch'))
model.addNode(Node(13, 300.0, -273.0, lambda x: 0.19, 'Lower microSwitch'))
model.addNode(Node(14, 0.01,-273.0, lambda x: 7.50, 'MLI-Upper platform'))
model.addNode(Node(15, 0.01,-273.0, lambda x: 2.78, 'MLI-lateral_2'))
model.addNode(Node(16, 0.01, -273.0, lambda x: 7.23, 'MLI-Lower platform'))
model.addNode(Node(17, 0.01,-273.0, lambda x: 2.15, 'Shunt_2'))
model.addNode(Node(18, 0.01,-273.0, lambda x: 2.15, 'Shunt_1'))
model.addNode(Node(19, 0.01,-273.0, lambda x: 2.78, 'MLI-lateral_1'))
model.addNode(Node(20, 100.0, -273.0, lambda x: 1.46, 'GPS_1 Antenna'))
model.addNode(Node(21, 100.0,-273.0, lambda x: 1.12, 'GPS_2 Antenna'))
model.addNode(Node(22, 100.0, -273.0, lambda x: 1.46, 'GPS_3 Antenna'))
model.addNode(Node(23, 100.0,-273.0, lambda x: 1.12, 'GPS_4 Antenna'))
...
model.addNode(Node(26, 450.0,-273.0,  lambda x: 1.95*F_AREA, 'Radiator_2'))
model.addNode(Node(27, 450.0,-273.0,  lambda x: 1.95*F_AREA, 'Radiator_1'))
model.addNode(Node(28, 250.0, -273.0, lambda x: 0.0, 'Structure - lateral_2'))
model.addNode(Node(29, 3.0, -273.0, lambda x: 1.56, 'MLI - magnetometer'))
